...
## .NET performance counters dashboard

![perf-counters-dashboard](https://raw.githubusercontent.com/karlospn/opentelemetry-metrics-demo/main/docs/perf-counters-dashboard.png)
